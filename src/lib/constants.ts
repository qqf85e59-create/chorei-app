...
export const GRADE_ORDER = ['E2a', 'E2b', 'E3a', 'E3b', 'E3c', 'E4', 'E4p', 'E5'] as const;
...
export const SESSION_STRUCTURE = [
  ...
  { label: '発話', duration: '5分', description: '発話者が主題について話す' },
  {
    label: '関心表明',
    duration: '2分',
    description: '聴取者7名が15〜20秒ずつ「関心を持った一点」を述べる',
  },
  {
    label: '締め',
    duration: '1分30秒',
    description: '運営が締めの挨拶、次回の告知',
  },
];
